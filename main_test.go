	...
	tests := []struct {
		...
		},
		{
			...
			wantStdout: []string{
				...
				"Licenses:", "(none)", "Description:", "(none)", "Homepage:", "(none)",
				"RepositoryURL:", "(none)", "DocumentationURL:", "(none)",
			},
		},
		{
			...
			outputJSON: false,
			wantStdout: []string{
				"Name:", "requests", "Version:", "2.32.5", "Ecosystem:", "pypi",
				"Licenses:", "Apache-2.0", "MIT", "Description:", "Python HTTP for Humans.",
				"Homepage:", "https://requests.readthedocs.io",
				"RepositoryURL:", "https://github.com/psf/requests", "DocumentationURL:", "(none)",
			},
		},
		{
			name: "JSON output",
			...
			wantStdout: []string{
				...
				`"licenses"`, `"MIT"`, `"homepage"`, `"https://lodash.com/"`,
...
func TestRunWithService_Success(t *testing.T) {
	...
	mockSvc := &mockService{
		info: PackageInfo{
			...
			RepositoryURL:    stringPtr("https://github.com/example/test"),
			Description:      stringPtr("Test package"),
			Ecosystem:        "npm",
			DocumentationURL: nil,
		},
		err: nil,
...
func TestRunWithService_JSONOutput(t *testing.T) {
	...
	mockSvc := &mockService{
		info: PackageInfo{
			...
			Version:          "2.0.0",
			Licenses:         []string{"Apache-2.0", "MIT"},
			Homepage:         stringPtr("https://json-test.io"),
			RepositoryURL:    stringPtr("https://github.com/test/json-test"),
			Description:      stringPtr("JSON test package"),
			Ecosystem:        "npm",
			DocumentationURL: stringPtr("https://docs.json-test.io"),
		},
		err: nil,
	}
